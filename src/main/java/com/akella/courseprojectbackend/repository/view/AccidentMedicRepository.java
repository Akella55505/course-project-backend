...
import com.akella.courseprojectbackend.dto.accident.AccidentMedicDto;
import com.akella.courseprojectbackend.model.view.AccidentMedic;
...
@Repository
public interface AccidentMedicRepository extends JpaRepository<AccidentMedic, Long> {
    @Query("""
    SELECT DISTINCT a FROM AccidentMedic a
